...
-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.ticket DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.ticket ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.ticket DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.ticket ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.estado DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.estado ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.estado DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.estado ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.prioridad DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.prioridad ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.prioridad DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.prioridad ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.comentario DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.comentario ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.comentario DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.comentario ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.ticket_encargado DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.ticket_encargado ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.ticket_encargado DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.ticket_encargado ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.rol DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.rol ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.rol DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.rol ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.usuario_rol DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.usuario_rol ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.usuario_rol DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.usuario_rol ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_creador | type: CONSTRAINT --
-- ALTER TABLE public.retroalimentacion DROP CONSTRAINT IF EXISTS id_usuario_creador CASCADE;
ALTER TABLE public.retroalimentacion ADD CONSTRAINT id_usuario_creador FOREIGN KEY (id_usuario_creador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: id_usuario_modificador | type: CONSTRAINT --
-- ALTER TABLE public.retroalimentacion DROP CONSTRAINT IF EXISTS id_usuario_modificador CASCADE;
ALTER TABLE public.retroalimentacion ADD CONSTRAINT id_usuario_modificador FOREIGN KEY (id_usuario_modificador)
REFERENCES public.usuario (id_usuario) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
